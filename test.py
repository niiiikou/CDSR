    ...
    for seed in seeds:
        ...
        for test_task in dev_counter:
            ...
            with open(config_file, "r") as f:
                config = json.load(f)
            # {"task_type": "classification", "options": ["negative", "positive"], "instruction": "Classify the following sentences by their sentiment: "}
            ...
            if args.use_demonstrations:
                ...
                print("set(:",set(["easiest", "hardest"]).intersection(priors))
                ...
                if use_difficulty:
                    ...
                    if args.difficulty == "concept_likelihood":
                        ...
                        if os.path.exists(concept_dir):
                            ...
                            concept_model = MetaICLModel(test_pripr_model, 
                            ...
                            concept_data = MetaICLData(logger, test_pripr_model, 
                        ...
                        if args.prefix_embed_file is not None:
                            print("&"*10)
                            model_dir = Path(args.prefix_embed_file).parent.absolute()
                            print("model_dir****************",os.path.join(model_dir, 'task2token.json'))
                        ...
                        exit(1)
                    # print("before difficulties:", difficulties)
                    difficulties = np.array(difficulties)
                    # print("after difficulties:", difficulties)
...
if __name__=='__main__':
    ...
    parser.add_argument("--unseen_domain_only", type=str, default=False)

    parser.add_argument("--split", type=str, default="test")
    parser.add_argument("--method", type=str, default="direct", 
        choices=["direct", "channel"])
    parser.add_argument("--gpt", type=str, default="gpt2-medium", 
